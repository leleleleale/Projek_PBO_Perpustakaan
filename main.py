...
class App:
    ...
    def _show_mode_select(self):
        self._clear()
        # Biar tombol maximize/resizable tidak terkunci di awal
    ...
    def _show_login_admin(self):
        self._clear()
        # Biar tombol maximize tidak terkunci saat di halaman login admin
        self.root.resizable(True, True)
    ...
    def _show_login_siswa(self):
        self._clear()
        # Supaya tombol maximize/resizable tidak terkunci di root saat mode login siswa
        self.root.resizable(True, True)
